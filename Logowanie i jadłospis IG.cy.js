...
describe("E2E - Jadłospis IG", () => {
    it("Logowanie, Moja Vitalia, Jadłospis. Nawodnienie i Makro", () => {
        ...
        cy.get("#login").type("testowe_vitalia_ig");
      ...
      .find('[class="card bg-light"]')
      .find(".card-body")
      .find('[class="alert bg-white border mb-0"]');
   ...
   .then(button => {
       expect(button).to.have.length(5)
       });
   ...
   .find('[class="standard-button submenu-actions-link"]')
   .eq(2)
   .should("contain", "Insulinooporność w pigułce");
   ...
   .find('[class="standard-button submenu-actions-link"]')
   .eq(4)
   .should("contain", "Ocena jadłospisu");
